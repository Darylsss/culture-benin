...
<body>
    <div class="container">
        <div class="illustration">
            <h2>Culture Bénin</h2>
            <p>Connectez-vous pour accéder à votre compte et découvrir nos divers contenus.</p>
            <svg width="250" height="200" viewBox="0 0 250 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="50" y="50" width="150" height="100" rx="10" fill="white" fill-opacity="0.2"/>
                <rect x="70" y="70" width="60" height="10" rx="5" fill="white" fill-opacity="0.7"/>
                <rect x="70" y="90" width="110" height="8" rx="4" fill="white" fill-opacity="0.5"/>
                <rect x="70" y="105" width="80" height="8" rx="4" fill="white" fill-opacity="0.5"/>
        ...
        <div class="form-container">
            ...
            <!-- Session Status -->
            @if (session('status'))
                <div style="color: var(--success); margin-bottom: 1rem; padding: 0.75rem; background-color: #f0fdf4; border-radius: 8px;">
                    {{ session('status') }}
                </div>
            @endif
